	...
	<body>
		<?php
            if(!isset($_COOKIE['session_cookie'])) {
              	echo "<h3>Couldn't set session correctly. Try login again!!!</h3><br><a href='login.php' class='button'><button type='submit' class='btn btn-warning' id='dsc' name='dsc'> Login </button></a>";
            }
        ?>
